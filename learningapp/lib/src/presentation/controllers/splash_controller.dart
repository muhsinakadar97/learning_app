...
import 'package:learningapp/src/presentation/screens/verify_number/verify_number.dart';
...
class SplashController extends GetxController {
  ...
  Future<void> initHive() async {
    ...
    if (currentUser != null) {
      ...
      // Get.offAll(const ButtonPage());
      Get.offAll(const VerifyNumber());
      // navigateToHome();
...
// Save the user to hive if first login after installation
...
// method to navigate to home if the user exists
  void navigateToHome() {
    Get.offAll(() => const BottomNav());
  }

// method to navigate to login if the user not exists
