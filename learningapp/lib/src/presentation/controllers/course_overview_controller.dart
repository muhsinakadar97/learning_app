...
class CourseOverviewController extends GetxController {
  ...
  // handle selected chapter
  RxString selectedChapterVideoId = "".obs;
  RxString selectedChapterName = "".obs;
  RxList<Chapter> selectedChapterList = RxList([]);
  RxString selectedSectionName = "".obs;
  RxInt selectedChapterIndex = RxInt(0);
  ...
  onChapterSelected(Section currentSection, int chapterIndex) {
    ...
    selectedChapterVideoId.value =
        currentSection.chapters[chapterIndex].videoId;
    selectedChapterName.value =
        currentSection.chapters[chapterIndex].chapterName;
    selectedChapterList.value = currentSection.chapters;
    selectedSectionName.value = currentSection.sectionName;

    //..................................................................

    Get.to(() => const ViewVideo(
